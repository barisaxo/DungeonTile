...
{/* My copy-pastable asset holder script. Has my prefered default Camera settings. 
  * Saves a lot of time and trouble when trying to find file paths, etc.*/
    ...
    void Awake()
    {
        ...
        sprite[6] = Resources.Load<Sprite>("ART/bg1");
        //
        sprite[7] = Resources.Load<Sprite>("ART/ShipTile");
        sprite[8] = Resources.Load<Sprite>("ART/MSSTile");
        sprite[9] = Resources.Load<Sprite>("ART/CuBeeTile");
        sprite[10] = Resources.Load<Sprite>("ART/CSSTile");
